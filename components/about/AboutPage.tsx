...
import { 
  ...
  Cpu, Battery, Sun, Layers, Flame, Crown, X, ChevronLeft, ChevronRight, Info, List, FileText, Download, ShoppingCart
} from 'lucide-react';
...
// Define the props interface for the AboutPage component
